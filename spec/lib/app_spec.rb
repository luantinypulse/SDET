...
describe CheerLeaderList do
  ...
  context "Cheer Leader list sorting" do
    ...
    it "Cheres Leader list can be sorted asc/desc by rank " do 
      expect(@list.sort_by('rank')).to eq([[1, "tuan", 1, 1], [2, "luan", 2, 2], [3, "mai", 2, 3]])
      expect(@list.sort_by('rank',false)).to eq([[3, "mai", 2, 3], [2, "luan", 2, 2], [1, "tuan", 1, 1]])
    end

    it "Cheres Leader list can be sorted asc/desc by name " do 
    ...
    it "Cheres Leader list can be sorted asc/desc by sent " do 
    ...
    it "Cheres Leader list can be sorted asc/desc by received " do 
